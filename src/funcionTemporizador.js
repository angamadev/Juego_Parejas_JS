// Creo funcion nueva para agregar otro temporizador
class Timer {
    min;
    sec;
    ms;
    ...
    constructor(idElement = "tiempo") {
      console.log("Creamos un Timer");
      this.idElement = idElement;
  
      if (localStorage.getItem("tiempo") !== null) {
        let timerFromLocalStorage = JSON.parse(localStorage.getItem("tiempo"));
        ...
        if (this.ms == 100) {
          ...
          if (this.sec == 60) {
            ...
            if (this.sec % 2 == 0) {
              ...
              localStorage.setItem("tiempo", JSON.stringify(timerObject));
            }
            this.sec++;
          }
        } else {
